document.addEventListener("DOMContentLoaded", () => {
  ...
  container.innerHTML = articles
    ...
    <div class="service-card">
      ${
        article.image
          ? `<img src="${article.image}" alt="${article.title}" style="width:100%; border-radius:8px; margin-bottom:15px;">`
          : ""
      }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  container.innerHTML = `
    ${
      article.image
        ? `<img src="${article.image}" alt="${article.title}" style="width:100%; border-radius:10px; margin-bottom:20px;">`
        : ""
    }
    ${article.content}
  `;
